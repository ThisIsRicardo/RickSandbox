...
@track currentExpense = {
  ...
  @track selectedColumns = [
    ...
    { label: 'Budget', fieldName: 'budgetCategory', fixedWidth: 400 },
    {
      type: 'action',
      typeAttributes: {
        rowActions: [
  ...
  async connectedCallback() {
    ...
    getAdministrationSubcategoryId()
    .then(result => {
        this.recruitmentAdministrationSubcategoryIdadministrationSubcategoryId = result; // Assuming you've declared administrationSubcategoryId as a tracked property
  ...
  getExpensesforDataTable() {
    ...
    getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
      .then(result => {
        ...
        this.recruitmentExpenses = this.expenses.filter(expense => expense.budgetCategory === 'Recruitment, Trainees and Marketing');
        this.employeeExpenses = this.expenses.filter(expense => expense.budgetCategory === 'Employee Experience and Development');
        this.administrationExpenses = this.expenses.filter(expense => expense.subcategoryId === this.recruitmentAdministrationSubcategoryId);
