...
async handleSaveExpenses() {
  ...
  if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c) {
    ...
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'warning',
        message: 'License field is empty, please fill in',
        variant: 'error'
      })
    );
    return;
  ...
  } else if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c && this.isTeamMemberIconVisible) {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'Error',
        message: 'Please, fill in all the required fields.',
