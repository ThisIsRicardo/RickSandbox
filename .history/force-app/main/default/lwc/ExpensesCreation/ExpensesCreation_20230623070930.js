...
async fetchCreditCardName(creditCardId) {
  try {
    const creditCard = await getRecordUi({
      recordIds: [creditCardId],
      layoutTypes: ['Compact'],
      modes: ['View']
    });
    return creditCard.records[creditCardId].fields.Name.value;
  } catch (error) {
...
async fetchStatementName(statementId) {
  try {
    const statement = await getRecordUi({
      recordIds: [statementId],
      layoutTypes: ['Compact'],
      modes: ['View']
    });
    return statement.records[statementId].fields.Name.value;
  } catch (error) {
...
async fetchTeamMemberName(teamMemberId) {
  try {
    const teamMember = await getRecordUi({
      recordIds: [teamMemberId],
      layoutTypes: ['Compact'],
      modes: ['View']
    });
    return teamMember.records[teamMemberId].fields.Name.value;
  } catch (error) {
...
async fetchLicenseName(licenseId) {
  try {
    const license = await getRecordUi({
      recordIds: [licenseId],
      layoutTypes: ['Compact'],
      modes: ['View']
    });
    return license.records[licenseId].fields.Name.value;
  } catch (error) {
...
async fetchCourseName(courseId) {
  try {
    const course = await getRecordUi({
      recordIds: [courseId],
      layoutTypes: ['Compact'],
      modes: ['View']
    });
    return course.records[courseId].fields.Name.value;
  } catch (error) {
