    ...
    return getBudget({
      ...
      .then(result => {
        ...
        if (
          result &&
          this.currentExpense.Amount_Spent__c >
          result.Available_Amount__c && this.currentExpense.Subcategory__c !== this.recruitmentAdministrationSubcategoryId && this. this.employeeAdministrationSubcategoryId
        ) {
