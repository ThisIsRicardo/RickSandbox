...
@track currentExpense = {
  ...
  @track selectedColumns = [
    { label: 'Transaction Date', fieldName: 'transactionDate', fixedWidth: 175},
    { label: 'Payment Concept', fieldName: 'name', fixedWidth: 200},
    { label: 'Amount Spent', fieldName: 'amountSpent', type: 'currency', fixedWidth: 175 },
    //{ label: 'Associated Credit Card', fieldName: 'Associated_Credit_Card__c' },
    { label: 'Category', fieldName: 'subcategoryName', fixedWidth: 200 },
    { label: 'Budget', fieldName: 'budgetCategory', fixedWidth: 300 },
