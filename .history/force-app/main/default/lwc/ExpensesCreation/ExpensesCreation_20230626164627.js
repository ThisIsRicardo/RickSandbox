...
import getSubCategoryOptions from '@salesforce/apex/ExpenseController.getSubCategoryOptions';
...
// ...
  ...
  @wire(getSubCategoryOptions, { filterValue: 'Your Filter Value' })
  wiredSubCategoryOptions({ data, error }) {
      if (data) {
          this.subCategoryOptions = data.map(option => {
              return {
                  label: option.Name,
                  value: option.Id
              };
