...
async handleSaveExpenses() {
  ...
  } else if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c || !this.currentExpense.Associated_Team_Member__c && this.transactionType === 'One Team Member') {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'Error',
        message: 'Please, fill in all the required fields.',
