...
async handleSaveExpenses() {
  ...
  // Normal Expense
  if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c && this.transactionType === 'Normal Expense') {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'Error',
