...
console.log(this.employeeAdministrationSubcategoryId); // Add this before the filter
    ...
    getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
      .then(result => {
        ...
        this.recruitmentExpenses = this.expenses.filter(expense => expense.budgetCategory === 'Recruitment, Trainees and Marketing' && expense.subcategoryId !== this.recruitmentAdministrationSubcategoryId && expense.subca);
