...
handleSubcategorySelect(event) {
  ...
  this.template.host.fetchSubcategoryName(selectedSubcategoryId)
  .then(result => {
...
handleCreditCardSelect(event) {
  ...
  this.template.host.fetchCreditCardName(selectedCreditCardId)
  .then(result => {
      let expenseWrapper = new ExpenseWrapper(this.newExpense);
...
handleStatementSelect(event) {
  ...
  this.template.host.fetchStatementName(selectedStatementId)
  .then(result => {
      let expenseWrapper = new ExpenseWrapper(this.newExpense);
      expenseWrapper.setStatementName(result);
      this.transactions.push(expenseWrapper);
  })
  .catch(error => {
      console.error(error);
...
handleTeamMemberSelect(event) {
  ...
  this.template.host.fetchTeamMemberName(selectedTeamMemberId)
  .then(result => {
      let expenseWrapper = new ExpenseWrapper(this.newExpense);
...
handleLicenseSelect(event) {
  ...
  this.template.host.fetchLicenseName(selectedLicenseId)
  .then(result => {
      let expenseWrapper = new ExpenseWrapper(this.newExpense);
...
handleCourseSelect(event) {
  ...
  this.template.host.fetchCourseName(selectedCourseId)
  .then(result => {
      let expenseWrapper = new ExpenseWrapper(this.newExpense);
