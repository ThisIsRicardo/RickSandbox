...
// ...
  ...
  get formattedTotalAmountSpent() {
    return this.totalAmountSpentApproved.toFixed(2);
  }
}
...
handleAddExpense() {
  ...
  for (let i = 0; i < this.transactions.length; i++) {
    if (this.transactions[i].Submit_for_Approval__c === false) {
      this.totalAmountSpentApproved = this.totalAmountSpentApproved + this.transactions[i].Amount_Spent__c;
  }
}
  // clear out the form fields by resetting the single item in the `expenses` array
  this.expenses[0] = {
