...
async handleSaveExpenses() {
  ...
  if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c) {
    ...
    return;
    // License Expense
  } else if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c  || !this.current && this.isLicenseVisible === true) {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'warning',
        message: 'Please, fill in all the required fields.',
