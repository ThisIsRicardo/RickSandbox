...
getRowOptions(rowId) {
  ...
  handleTransactionTypeChange(event) {
    ...
    // check if the selected type is 'License' or 'Event'
    if (this.transactionType === 'License' || this.transactionType === 'Event') {
  ...
  handleSaveExpenses() {
    ...
    //Save the values that transaction contains

    saveExpenses({expenses : this.tran })
      .then(result => {
