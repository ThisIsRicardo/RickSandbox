...
console.log('ID is ', expense.subcategoryId)
    ...
    getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
      .then(result => {
        ...
        this.recruitmentExpenses = this.expenses.filter(expense =>  expense.subcategoryId !== this.recruitmentAdministrationSubcategoryId && expense.subcategoryId !== this.employeeAdministrationSubcategoryId);
