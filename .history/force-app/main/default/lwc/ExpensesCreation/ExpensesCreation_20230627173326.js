      ...
      switch (this.otherExpenseType) {
        case 'One':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: "One team member's expense selection was added successfully.",
              variant: 'success'
            })
          );
      break;
        case 'Multiple Team Members':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: "Multiple team members' selection was added successfully.",
              variant: 'success'
            })
          );
          break;
        case 'None':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: 'Expense selection for non-team members was added successfully.',
              variant: 'success'
