...
@track currentExpense = {
  ...
  @track selectedColumns = [
    ...
    { label: 'Amount Spent', fieldName: 'amountSpent', type: 'currency', fixedWidth: 100 },
    //{ label: 'Associated Credit Card', fieldName: 'Associated_Credit_Card__c' },
    { label: 'Category', fieldName: 'subcategoryName', fixedWidth: 100 },
    { label: 'Budget', fieldName: 'budgetCategory', fixedWidth: 200 },
