    ...
    return getBudget({
      ...
      .then(result => {
        ...
        if (
          result &&
          this.currentExpense.Amount_Spent__c >
          result.Available_Amount__c && result.Subcategory__c !== this.recruitmentAdministrationSubcategoryId || this.employeeAdministrationSubcategoryId
        ) {
          ...
          console.log('Subcategory ID' , result.Subcategory__c)
        } else {
          this.currentExpense.showWarning = false
