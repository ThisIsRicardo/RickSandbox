...
getRowOptions(rowId) {
  ...
  handleAddExpense() {
    ...
    let newExpense = {
        Transaction_Date__c: this.transactionDate,
        Name: this.Name,
        Subcategory__c: this.selectedSubcategory,
        Amount_Spent__c: this.amountSpent,
        Associated_Credit_Card__c: this.associatedCreditCard,
        Associated_Team_Member__c: this.associatedTeamMember,
        License__c: this.license,
        Course__c: this.event,
        Receipt_Type__c: this.receiptType
    };

    // add the new expense to the array
    this.expenses = [...this.expenses, newExpense];

    // Also add to the 'transactions' array for data-table
    this.transactions = [...this.expenses];
    ...
    this.amountSpent = '';
    this.associatedCreditCard = '';
    this.associatedTeamMember = '';
    this.license = '';
    this.event = '';
    this.receiptType = '';
}
