...
handleAddExpense() {
  ...
  switch (this.transactionType) {
    ...
    case 'License':
      ...
      if (this.expenses[0].Transaction_Date__c === '' || this.expenses[0].Name === '' || this.expenses[0].Subcategory__c === '' || this.expenses[0].Amount_Spent__c === '' || this.expenses[0].Associated_Credit_Card__c === '' || this.expenses[0].License__c === '' || this.expenses[0].Receipt_Type__c === '') {
        this.dispatchEvent(
          new ShowToastEvent({
          ...
          // we need to stop the process of add if this is true.c/expensesCreation
        );
      } else {
      this.dispatchEvent(
        new ShowToastEvent({
