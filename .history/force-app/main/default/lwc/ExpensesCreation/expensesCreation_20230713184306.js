...
async handleSaveExpenses() {
  ...
  if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c) {
    ...
    return;
    // Event Expense
  } else if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c || !this.currentExpense.Course__c && this.) {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'Error',
        message: 'Please, fill in all the required fields.',
