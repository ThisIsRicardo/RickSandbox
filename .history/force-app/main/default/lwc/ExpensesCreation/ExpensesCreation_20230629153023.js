...
import callMyFlow from '@salesforce/apex/MyApexClass.callMyFlow';
...
@track currentExpense = {
  ...
  handleSendforApproval(){
    callMyFlow({statementId : this.currentExpense.Credit_Card_Statement__c})
    .then(result => {
        // handle successful invocation
        this.dispatchEvent(
            new ShowToastEvent({
                title: 'Success',
                message: 'Credit Card Statement was sent for approval successfully.',
                variant: 'success',
            }),
        );
    })
