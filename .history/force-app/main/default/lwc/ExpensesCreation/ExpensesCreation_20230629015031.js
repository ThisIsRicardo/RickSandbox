...
@track currentExpense = {
  ...
  @wire(getExpenses, { statementId: '$currentExpense.Credit_Card_Statement__c' }) wiredExpenses;
...
updateExpenseWithCreditCardStatement() {
  ...
  getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
    .then(result => {
      ...
      // Save the wired value
      this.wiredExpenses = result;
      // refresh data table
      return refreshApex(this.wiredExpenses);
    })
    .catch(error => {
...
handleSaveExpenses() {
  ...
  saveExpenses({ expense: this.currentExpense }) // remember to update the method name to saveExpense in your Apex class
    .then(result => {
      ...
      // Call the updateExpenseWithCreditCardStatement method after saving the expense
      this.updateExpenseWithCreditCardStatement();
    })
    .catch(error => {
