...
handleSaveExpenses() {
  saveExpense({ expense: this.currentExpense }) // update the method name to saveExpense in your Apex class
    .then(result => {
      // Handle successful save and reset the currentExpense
      this.dispatchEvent(
        new ShowToastEvent({
          title: 'Success',
      ...
      this.resetCurrentExpense(); // create this method to reset the currentExpense
    })
    .catch(error => {
      // Handle error
