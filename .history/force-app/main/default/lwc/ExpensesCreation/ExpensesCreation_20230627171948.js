      ...
      switch (this.otherExpenseType) {
        case 'One':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: 'Other Expense related to one team member has been selected successfully',
              variant: 'success'
            })
          );
          this.isTeamMemberVisible = true;
        ...
        case 'Multiple Team Members':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: 'Other Expense related to multiple team members has been selected successfully',
              variant: 'success'
            })
          );
        ...
        case 'None':
          this.dispatchEvent(
            new ShowToastEvent({
              title: 'Success',
              message: 'Other Expense related to none team members has been selected successfully',
              variant: 'success'
            })
          this.isTeamMemberVisible = false;
          this.isLicenseVisible = false;
...
handleAddExpense() {
  ...
  switch (this.transactionType) {
    ...
    case 'License':
      // if to check that all the required fields are filled
