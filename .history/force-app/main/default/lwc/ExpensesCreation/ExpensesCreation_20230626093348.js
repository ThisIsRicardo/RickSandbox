...
// ...
  ...
  @track recordType = '';
  @track RecruitmentTraineesMarketing = 'Recruitment, Trainees and Marketing';
  @track EmployeeExperienceDevelopment = 'Employee Experience and Development';
  ...
  @track recordTypeValues = [
    { Label: this.recruitmentRecor , value: this.recruitmentOwnerMetadata },
    { Label: this.employeeExperienceOwnerMetadata , value: this.employeeExperienceOwnerMetadata }
  ]
