...
import getRecruitmentAdministrationSubcategoryId from '@salesforce/apex/YourApexClass.getRecruitmentAdministrationSubcategoryId';
  ...
  getExpensesforDataTable() {
    ...
    getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
      .then(result => {
        ...
        this.administrationExpenses = this.expenses.filter(expense => expense.budgetCategory === 'Administration');
