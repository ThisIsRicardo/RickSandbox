...
async handleSaveExpenses() {
  ...
  if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c) {
    ...
    return;
    // License Expense
  } else if (!this.currentExpense.Transaction_Date__c || !this.currentExpense.Name || !this.currentExpense.Subcategory__c || !this.currentExpense.Amount_Spent__c || !this.currentExpense.License__c && isLicense) {
    this.dispatchEvent(
      new ShowToastEvent({
        title: 'Error',
        message: 'Please, fill in all the required fields.',
