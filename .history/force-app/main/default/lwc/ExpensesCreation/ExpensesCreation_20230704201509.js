...
console.log(this.employeeAdministrationSubcategoryId); // Add this before the filter
    ...
    getExpenses({ statementId: this.currentExpense.Credit_Card_Statement__c })
      .then(result => {
        ...
        this.administrationExpenses = this.expenses.filter(expense => expense.subcategoryId === this.recruitmentAdministrationSubcategoryId || this.employeeAdministrationSubcategoryId);
